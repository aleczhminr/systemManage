...
namespace DAL.Base
{
		...
		/// Sys_VisitSms
		/// </summary>
	public  class Sys_VisitSmsBaseDAL
	{ 
        /// <summary>
        /// 新增加一条数据
        /// </summary>
        ...
        /// <returns></returns>
        public int Add(Sys_VisitSms model)
        {

            StringBuilder strSql = new StringBuilder();
			strSql.Append("insert into Sys_VisitSms(");			
            strSql.Append("accid,phoneNum,systype,smsContent,sendtime,sendStatus,smsChannel,priority,realCnt,recordVisit,Remark,insertime");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sys_VisitSms model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Sys_VisitSms set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Sys_VisitSms ");
			strSql.Append(" where id=@id");
		...
		/// 得到一个对象实体
		/// </summary>
		public Sys_VisitSms GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, accid, phoneNum, systype, smsContent, sendtime, sendStatus, smsChannel, priority, realCnt, recordVisit, Remark, insertime  ");			
			strSql.Append("  from Sys_VisitSms ");
			strSql.Append(" where id=@id");
            return  DapperHelper.GetModel<Sys_VisitSms>(strSql.ToString(), new { id  = id  });
		}
        ...
        public List<Sys_VisitSms> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<Sys_VisitSms>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<Sys_VisitSms> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from Sys_VisitSms ");
        ...
        public List<Sys_VisitSms> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from Sys_VisitSms T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from Sys_VisitSms T  ");
