...
namespace DAL.Base
{
    ...
    /// 支出信息
    /// </summary>
    public class t_PayRecordBaseDAL
    {
        ...
        /// 得到一个对象实体
        /// </summary>
        public t_PayRecord GetModel(long ID)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID, PayDate, PaySum, PayMaxType, PayName, PayMinType, RandomNumber, ShopperId, IfLoan  ");
            strSql.Append("  from I200.dbo.t_PayRecord ");
            strSql.Append(" where ID=@ID");
            return DapperHelper.GetModel<t_PayRecord>(strSql.ToString(), new { ID = ID });
        }
        ...
        public List<t_PayRecord> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<t_PayRecord>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<t_PayRecord> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from I200.dbo.t_PayRecord ");
        ...
        public List<t_PayRecord> GetList(int pageIndex, int pageSize, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from I200.dbo.t_PayRecord T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from I200.dbo.t_PayRecord T  ");
