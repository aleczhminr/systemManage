...
namespace DAL.Base
{
		...
		/// Sys_TaskType
		/// </summary>
	public  class Sys_TaskTypeBaseDAL
	{ 
        /// <summary>
        /// 新增加一条数据
        /// </summary>
        ...
        /// <returns></returns>
        public int Add(Sys_TaskType model)
        {

            StringBuilder strSql = new StringBuilder();
			strSql.Append("insert into Sys_TaskType(");			
            strSql.Append("tt_Marked,tt_Name,tt_Explanation,dt_Level,vr_MaxId,vr_MinId,insertTime,insertName");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sys_TaskType model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Sys_TaskType set ");
			                                                
            strSql.Append(" tt_Marked = @tt_Marked , ");                                    
            strSql.Append(" tt_Name = @tt_Name , ");                                    
            strSql.Append(" tt_Explanation = @tt_Explanation , ");                                    
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Sys_TaskType ");
			strSql.Append(" where id=@id");
		...
		/// 得到一个对象实体
		/// </summary>
		public Sys_TaskType GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, tt_Marked, tt_Name, tt_Explanation, dt_Level, vr_MaxId, vr_MinId, insertTime, insertName  ");			
			strSql.Append("  from Sys_TaskType ");
			strSql.Append(" where id=@id");
            return  DapperHelper.GetModel<Sys_TaskType>(strSql.ToString(), new { id  = id  });
		}
        ...
        public List<Sys_TaskType> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<Sys_TaskType>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<Sys_TaskType> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from Sys_TaskType ");
        ...
        public List<Sys_TaskType> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from Sys_TaskType T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from Sys_TaskType T  ");
