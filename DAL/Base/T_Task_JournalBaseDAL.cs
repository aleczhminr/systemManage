...
namespace DAL.Base
{
    ...
    /// 前台任务分享记录
    /// </summary>
    public class T_Task_JournalBaseDAL
    {
        ...
        /// 得到一个对象实体
        /// </summary>
        public T_Task_Journal GetModel(int id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id, t_longitude, t_latitude, acc_id, t_explan, t_type, t_time, t_remarks, t_status, t_source  ");
            strSql.Append("  from I200.dbo.T_Task_Journal ");
            strSql.Append(" where id=@id");
            return DapperHelper.GetModel<T_Task_Journal>(strSql.ToString(), new { id = id });
        }
        ...
        public List<T_Task_Journal> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<T_Task_Journal>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<T_Task_Journal> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from I200.dbo.T_Task_Journal ");
        ...
        public List<T_Task_Journal> GetList(int pageIndex, int pageSize, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from I200.dbo.T_Task_Journal T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from I200.dbo.T_Task_Journal T  ");
