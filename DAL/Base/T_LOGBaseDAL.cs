...
namespace DAL.Base
{
    ...
    public class T_LOGBaseDAL
    {
        ...
        /// 得到一个对象实体
        /// </summary>
        public T_LOG GetModel(int ID)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID, LogType, OperDate, Account_user_id, LogInfo, LogMode, TypeID, Accountid, Loginbrslast  ");
            strSql.Append("  from I200.dbo.T_LOG ");
            strSql.Append(" where ID=@ID");
            return DapperHelper.GetModel<T_LOG>(strSql.ToString(), new { ID = ID });
        }
        ...
        public List<T_LOG> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<T_LOG>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<T_LOG> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from I200.dbo.T_LOG ");
        ...
        public List<T_LOG> GetList(int pageIndex, int pageSize, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from I200.dbo.T_LOG T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from I200.dbo.T_LOG T  ");
