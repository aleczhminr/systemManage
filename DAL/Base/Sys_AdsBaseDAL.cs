...
namespace DAL.Base
{
	...
	{ 
        ...
        /// <returns></returns>
        public int Add(Sys_Ads model)
        {

            StringBuilder strSql = new StringBuilder();
			strSql.Append("insert into Sys_Ads(");			
            strSql.Append("title,picString,adString,createTime,startTime,endTime,status,viewNums,operatorId");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sys_Ads model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Sys_Ads set ");
			                                                
            strSql.Append(" title = @title , ");                                    
            strSql.Append(" picString = @picString , ");                                    
            strSql.Append(" adString = @adString , ");                                    
            strSql.Append(" createTime = @createTime , ");                                    
            strSql.Append(" startTime = @startTime , ");                                    
            strSql.Append(" endTime = @endTime , ");                                    
            strSql.Append(" status = @status , ");                                    
            strSql.Append(" viewNums = @viewNums , ");                                    
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Sys_Ads ");
			strSql.Append(" where id=@id");
		...
		/// 得到一个对象实体
		/// </summary>
		public Sys_Ads GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, title, picString, adString, createTime, startTime, endTime, status, viewNums, operatorId  ");			
			strSql.Append("  from Sys_Ads ");
			strSql.Append(" where id=@id");
            return  DapperHelper.GetModel<Sys_Ads>(strSql.ToString(), new { id  = id  });
		}
        ...
        public List<Sys_Ads> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<Sys_Ads>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<Sys_Ads> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from Sys_Ads ");
        ...
        public List<Sys_Ads> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from Sys_Ads T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from Sys_Ads T  ");
