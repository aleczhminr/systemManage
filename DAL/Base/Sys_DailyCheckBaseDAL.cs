...
namespace DAL.Base
{
    ...
    /// Sys_DailyCheck
    /// </summary>
    public class Sys_DailyCheckBaseDAL
    {
        /// <summary>
        /// 新增加一条数据
        /// </summary>
        ...
        public bool Delete(int Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from Sys_DailyCheck ");
            strSql.Append(" where Id=@Id");
        ...
        /// 得到一个对象实体
        /// </summary>
        public Sys_DailyCheck GetModel(int Id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select Id, TaskStatus, TaskName, IsRepeat, RepeatType, RepeatTime, RemindTime, Reminder, Recorder, RecordTime  ");
            strSql.Append("  from Sys_DailyCheck ");
            strSql.Append(" where Id=@Id");
            return DapperHelper.GetModel<Sys_DailyCheck>(strSql.ToString(), new { Id = Id });
        }
        ...
        public List<Sys_DailyCheck> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<Sys_DailyCheck>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<Sys_DailyCheck> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from Sys_DailyCheck ");
        ...
        public List<Sys_DailyCheck> GetList(int pageIndex, int pageSize, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from Sys_DailyCheck T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from Sys_DailyCheck T  ");
