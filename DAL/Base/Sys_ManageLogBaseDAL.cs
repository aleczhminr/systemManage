...
namespace DAL.Base
{
		...
		/// Sys_ManageLog
		/// </summary>
	public  class Sys_ManageLogBaseDAL
	{ 
        /// <summary>
        /// 新增加一条数据
        /// </summary>
        ...
        /// <returns></returns>
        public int Add(Sys_ManageLog model)
        {

            StringBuilder strSql = new StringBuilder();
			strSql.Append("insert into Sys_ManageLog(");			
            strSql.Append("LogType,OperDate,Managerid,LogInfo,LogMode,TypeID,Loginbrslast,IP");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sys_ManageLog model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Sys_ManageLog set ");
            ...
            strSql.Append(" LogMode = @LogMode , ");                                    
            strSql.Append(" TypeID = @TypeID , ");                                    
            strSql.Append(" Loginbrslast = @Loginbrslast , ");                                    
            strSql.Append(" IP = @IP  ");            			
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Sys_ManageLog ");
			strSql.Append(" where ID=@ID");
		...
		/// 得到一个对象实体
		/// </summary>
		public Sys_ManageLog GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID, LogType, OperDate, Managerid, LogInfo, LogMode, TypeID, Loginbrslast, IP  ");			
			strSql.Append("  from Sys_ManageLog ");
			strSql.Append(" where ID=@ID");
            return  DapperHelper.GetModel<Sys_ManageLog>(strSql.ToString(), new { ID  = ID  });
		}
        ...
        public List<Sys_ManageLog> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<Sys_ManageLog>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<Sys_ManageLog> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from Sys_ManageLog ");
        ...
        public List<Sys_ManageLog> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from Sys_ManageLog T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from Sys_ManageLog T  ");
