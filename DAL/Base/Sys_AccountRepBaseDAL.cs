...
namespace DAL.Base
{
		...
		/// Sys_AccountRep
		/// </summary>
	public  class Sys_AccountRepBaseDAL
	{ 
        /// <summary>
        /// 新增加一条数据
        /// </summary>
        ...
        /// <returns></returns>
        public int Add(Sys_AccountRep model)
        {

            StringBuilder strSql = new StringBuilder();
			strSql.Append("insert into Sys_AccountRep(");			
            strSql.Append("accid,statTime,endtime,insertTime,Browser");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sys_AccountRep model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Sys_AccountRep set ");
			                                                
            strSql.Append(" accid = @accid , ");                                    
            strSql.Append(" statTime = @statTime , ");                                    
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Sys_AccountRep ");
			strSql.Append(" where id=@id");
		...
		/// 得到一个对象实体
		/// </summary>
		public Sys_AccountRep GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, accid, statTime, endtime, insertTime, Browser  ");			
			strSql.Append("  from Sys_AccountRep ");
			strSql.Append(" where id=@id");
            return  DapperHelper.GetModel<Sys_AccountRep>(strSql.ToString(), new { id  = id  });
		}
        ...
        public List<Sys_AccountRep> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<Sys_AccountRep>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<Sys_AccountRep> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from Sys_AccountRep ");
        ...
        public List<Sys_AccountRep> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from Sys_AccountRep T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from Sys_AccountRep T  ");
