...
namespace DAL.Base
{
		...
		/// I200.dbo.T_UserInfo
		/// </summary>
	public  class  T_UserInfoBaseDAL
	{  
		...
		/// 得到一个对象实体
		/// </summary>
		public T_UserInfo GetModel(long uid)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select uid, uPhone, uRegTime, uQQ, uIntegral, accID, uIntegralUsed, uNumber, uAddress, uLike, uRemark, uStoreMoney, uGroup, uPY, uPinYin, isTime, uPwd, keepTime, uNick, uRank, uInsertTime, uOperator, uStoreTimes, uLastBuyDate, uAuthCode, uAuthCodeTime, uLockRank, uPortrait, weixin, alipay, uName, uSex, uEmail  ");			
			strSql.Append("  from I200.dbo.T_UserInfo ");
			strSql.Append(" where uid=@uid");
            return  DapperHelper.GetModel<T_UserInfo>(strSql.ToString(), new { uid  = uid  });
		}
        ...
        public List<T_UserInfo> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<T_UserInfo>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<T_UserInfo> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from I200.dbo.T_UserInfo ");
        ...
        public List< T_UserInfo> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from I200.dbo.T_UserInfo T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from I200.dbo.T_UserInfo T  ");
