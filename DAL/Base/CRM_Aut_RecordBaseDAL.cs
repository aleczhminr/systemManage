...
namespace DAL.Base
{
		...
		/// CRM_Aut_Record
		/// </summary>
	public  class CRM_Aut_RecordBaseDAL
	{ 
        /// <summary>
        /// 新增加一条数据
        /// </summary>
        ...
        /// <returns></returns>
        public int Add(CRM_Aut_Record model)
        {

            StringBuilder strSql = new StringBuilder();
			strSql.Append("insert into CRM_Aut_Record(");			
            strSql.Append("r_accid,r_max,r_min,t_tex,r_time,r_status,r_remark,r_result");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(CRM_Aut_Record model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update CRM_Aut_Record set ");
			                                                
            strSql.Append(" r_accid = @r_accid , ");                                    
            strSql.Append(" r_max = @r_max , ");                                    
            strSql.Append(" r_min = @r_min , ");                                    
            strSql.Append(" t_tex = @t_tex , ");                                    
            strSql.Append(" r_time = @r_time , ");                                    
            strSql.Append(" r_status = @r_status , ");                                    
            strSql.Append(" r_remark = @r_remark , ");                                    
            strSql.Append(" r_result = @r_result  ");            			
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from CRM_Aut_Record ");
			strSql.Append(" where id=@id");
		...
		/// 得到一个对象实体
		/// </summary>
		public CRM_Aut_Record GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, r_accid, r_max, r_min, t_tex, r_time, r_status, r_remark, r_result  ");			
			strSql.Append("  from CRM_Aut_Record ");
			strSql.Append(" where id=@id");
            return  DapperHelper.GetModel<CRM_Aut_Record>(strSql.ToString(), new { id  = id  });
		}
        ...
        public List<CRM_Aut_Record> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<CRM_Aut_Record>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<CRM_Aut_Record> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from CRM_Aut_Record ");
        ...
        public List<CRM_Aut_Record> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from CRM_Aut_Record T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from CRM_Aut_Record T  ");
