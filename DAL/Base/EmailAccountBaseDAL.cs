...
namespace DAL.Base
{
		...
		/// EmailAccount
		/// </summary>
	public  class EmailAccountBaseDAL
	{ 
        /// <summary>
        /// 新增加一条数据
        /// </summary>
        ...
        /// <returns></returns>
        public int Add(EmailAccount model)
        {

            StringBuilder strSql = new StringBuilder();
			strSql.Append("insert into EmailAccount(");			
            strSql.Append("sendType,accountContent,sendNumber,updatetime");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(EmailAccount model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update EmailAccount set ");
			                                                
            strSql.Append(" sendType = @sendType , ");                                    
            strSql.Append(" accountContent = @accountContent , ");                                    
		...
		/// 得到一个对象实体
		/// </summary>
		public EmailAccount GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, sendType, accountContent, sendNumber, updatetime  ");			
			strSql.Append("  from EmailAccount ");
			strSql.Append(" where id=@id");
            return  DapperHelper.GetModel<EmailAccount>(strSql.ToString(), new { id  = id  });
		}
        ...
        public List<EmailAccount> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<EmailAccount>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<EmailAccount> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from EmailAccount ");
        ...
        public List<EmailAccount> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from EmailAccount T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from EmailAccount T  ");
