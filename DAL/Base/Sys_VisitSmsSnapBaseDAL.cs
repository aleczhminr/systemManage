...
namespace DAL.Base
{
		...
		/// Sys_VisitSmsSnap
		/// </summary>
	public  class Sys_VisitSmsSnapBaseDAL
	{ 
        /// <summary>
        /// 新增加一条数据
        /// </summary>
        ...
        /// <returns></returns>
        public int Add(Sys_VisitSmsSnap model)
        {

            StringBuilder strSql = new StringBuilder();
			strSql.Append("insert into Sys_VisitSmsSnap(");			
            strSql.Append("accid,phoneNum,systype,smstype,smsContent,sendtime,sendStatus,smsChannel,priority,realCnt,recordVisit,Remark,insertime");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sys_VisitSmsSnap model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Sys_VisitSmsSnap set ");
            ...
            strSql.Append(" smsChannel = @smsChannel , ");                                    
            strSql.Append(" priority = @priority , ");                                    
            strSql.Append(" realCnt = @realCnt , ");                                    
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Sys_VisitSmsSnap ");
			strSql.Append(" where id=@id");
		...
		/// 得到一个对象实体
		/// </summary>
		public Sys_VisitSmsSnap GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, accid, phoneNum, systype, smstype, smsContent, sendtime, sendStatus, smsChannel, priority, realCnt, recordVisit, Remark, insertime  ");			
			strSql.Append("  from Sys_VisitSmsSnap ");
			strSql.Append(" where id=@id");
            return  DapperHelper.GetModel<Sys_VisitSmsSnap>(strSql.ToString(), new { id  = id  });
		}
        ...
        public List<Sys_VisitSmsSnap> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<Sys_VisitSmsSnap>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<Sys_VisitSmsSnap> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from Sys_VisitSmsSnap ");
        ...
        public List<Sys_VisitSmsSnap> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from Sys_VisitSmsSnap T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from Sys_VisitSmsSnap T  ");
