...
namespace DAL.Base
{
		...
		/// EmailTemplates
		/// </summary>
	public  class EmailTemplatesBaseDAL
	{ 
        /// <summary>
        /// 新增加一条数据
        /// </summary>
        ...
        /// <returns></returns>
        public int Add(EmailTemplates model)
        {

            StringBuilder strSql = new StringBuilder();
			strSql.Append("insert into EmailTemplates(");			
            strSql.Append("temp_Content,inertTime,inertId,showImg");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(EmailTemplates model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update EmailTemplates set ");
			                                                
            strSql.Append(" temp_Content = @temp_Content , ");                                    
            strSql.Append(" inertTime = @inertTime , ");                                    
            strSql.Append(" inertId = @inertId , ");                                    
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from EmailTemplates ");
			strSql.Append(" where id=@id");
		...
		/// 得到一个对象实体
		/// </summary>
		public EmailTemplates GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, temp_Content, inertTime, inertId, showImg  ");			
			strSql.Append("  from EmailTemplates ");
			strSql.Append(" where id=@id");
            return  DapperHelper.GetModel<EmailTemplates>(strSql.ToString(), new { id  = id  });
		}
        ...
        public List<EmailTemplates> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<EmailTemplates>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<EmailTemplates> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from EmailTemplates ");
        ...
        public List<EmailTemplates> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from EmailTemplates T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from EmailTemplates T  ");
