...
namespace DAL.Base
{
		...
		/// sys_ManageRep
		/// </summary>
	public  class sys_ManageRepBaseDAL
	{ 
        /// <summary>
        /// 新增加一条数据
        /// </summary>
        ...
        /// <returns></returns>
        public int Add(sys_ManageRep model)
        {

            StringBuilder strSql = new StringBuilder();
			strSql.Append("insert into sys_ManageRep(");			
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(sys_ManageRep model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update sys_ManageRep set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from sys_ManageRep ");
			strSql.Append(" where id=@id");
		...
		/// 得到一个对象实体
		/// </summary>
		public sys_ManageRep GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, accid, statTime, endtime, insertTime, Browser  ");			
			strSql.Append("  from sys_ManageRep ");
			strSql.Append(" where id=@id");
            return  DapperHelper.GetModel<sys_ManageRep>(strSql.ToString(), new { id  = id  });
		}
        ...
        public List<sys_ManageRep> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<sys_ManageRep>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<sys_ManageRep> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from sys_ManageRep ");
        ...
        public List<sys_ManageRep> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from sys_ManageRep T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from sys_ManageRep T  ");
