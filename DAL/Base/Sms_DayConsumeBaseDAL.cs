...
namespace DAL.Base
{
		...
		/// Sms_DayConsume
		/// </summary>
	public  class Sms_DayConsumeBaseDAL
	{ 
        /// <summary>
        /// 新增加一条数据
        /// </summary>
        ...
        /// <returns></returns>
        public int Add(Sms_DayConsume model)
        {

            StringBuilder strSql = new StringBuilder();
			strSql.Append("insert into Sms_DayConsume(");			
            strSql.Append("passageNum,sms_Num,sms_Sendtime,sms_Source,sms_Name,sms_remark,sms_status");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sms_DayConsume model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Sms_DayConsume set ");
			                                                
            strSql.Append(" passageNum = @passageNum , ");                                    
            strSql.Append(" sms_Num = @sms_Num , ");                                    
            strSql.Append(" sms_Sendtime = @sms_Sendtime , ");                                    
            strSql.Append(" sms_Source = @sms_Source , ");                                    
            strSql.Append(" sms_Name = @sms_Name , ");                                    
            strSql.Append(" sms_remark = @sms_remark , ");                                    
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Sms_DayConsume ");
			strSql.Append(" where id=@id");
		...
		/// 得到一个对象实体
		/// </summary>
		public Sms_DayConsume GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, passageNum, sms_Num, sms_Sendtime, sms_Source, sms_Name, sms_remark, sms_status  ");			
			strSql.Append("  from Sms_DayConsume ");
			strSql.Append(" where id=@id");
            return  DapperHelper.GetModel<Sms_DayConsume>(strSql.ToString(), new { id  = id  });
		}
        ...
        public List<Sms_DayConsume> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<Sms_DayConsume>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<Sms_DayConsume> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from Sms_DayConsume ");
        ...
        public List<Sms_DayConsume> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from Sms_DayConsume T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from Sms_DayConsume T  ");
