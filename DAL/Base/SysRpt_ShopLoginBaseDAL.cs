...
namespace DAL.Base
{
		...
		/// SysRpt_ShopLogin
		/// </summary>
	public  class SysRpt_ShopLoginBaseDAL
	{ 
        /// <summary>
        /// 新增加一条数据
        /// </summary>
        ...
        /// <returns></returns>
        public int Add(SysRpt_ShopLogin model)
        {

            StringBuilder strSql = new StringBuilder();
			strSql.Append("insert into SysRpt_ShopLogin(");			
            strSql.Append("accountid,AgentId,regTime,num,loginType,startTime,endTime,firstId,stateVal");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(SysRpt_ShopLogin model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update SysRpt_ShopLogin set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from SysRpt_ShopLogin ");
			strSql.Append(" where id=@id");
		...
		/// 得到一个对象实体
		/// </summary>
		public SysRpt_ShopLogin GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, accountid, AgentId, regTime, num, loginType, startTime, endTime, firstId, stateVal  ");			
			strSql.Append("  from SysRpt_ShopLogin ");
			strSql.Append(" where id=@id");
            return  DapperHelper.GetModel<SysRpt_ShopLogin>(strSql.ToString(), new { id  = id  });
		}
        ...
        public List<SysRpt_ShopLogin> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<SysRpt_ShopLogin>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<SysRpt_ShopLogin> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from SysRpt_ShopLogin ");
        ...
        public List<SysRpt_ShopLogin> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from SysRpt_ShopLogin T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from SysRpt_ShopLogin T  ");
