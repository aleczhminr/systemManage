...
namespace DAL.Base
{
    ...
    /// I200.dbo.T_SaleInfo
    /// </summary>
    public class T_SaleInfoBaseDAL
    { 

        /// <summary>
        /// 得到一个对象实体
        /// </summary>
        public T_SaleInfo GetModel(int saleID)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select saleID, payType, AbleMoney, RealMoney, DiffMoney, StoreTimes, StoreMoney, CashMoney, CardMoney, UnpaidMoney, ReturnBackMoney, saleNo, isSendSMS, isPrintTicket, operatorID, operatorTime, operatorIP, exJson, zt, CouponMoney, CouponID, CouponCode, accID, SerialNum, AlipayMoney, isRetail, uid, saleTime, insertTime, saleKind, saleNum  ");
            strSql.Append("  from I200.dbo.T_SaleInfo ");
            strSql.Append(" where saleID=@saleID");
            return DapperHelper.GetModel<T_SaleInfo>(strSql.ToString(), new { saleID = saleID });
        }
        ...
        public List< T_SaleInfo> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<T_SaleInfo>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<T_SaleInfo> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from I200.dbo.T_SaleInfo ");
        ...
        public List<T_SaleInfo> GetList(int pageIndex, int pageSize, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from I200.dbo.T_SaleInfo T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from I200.dbo.T_SaleInfo T  ");
