...
namespace DAL.Base
{
    ...
    /// 优惠券
    /// </summary>
    public class T_Order_CouponInfoBaseDAL
    {

        /// <summary>
        /// 得到一个对象实体
        /// </summary>
        public T_Order_CouponInfo GetModel(int id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id, couponDesc, maxLimitNum, createDate, endDate, operatorId, operarorIp, operatorTime, remark, prefixAgent, couponType, bindType, bindValue, bindName, ruleType, ruleValue, couponValue, couponStatus  ");
            strSql.Append("  from I200.dbo.T_Order_CouponInfo ");
            strSql.Append(" where id=@id");
            return DapperHelper.GetModel<T_Order_CouponInfo>(strSql.ToString(), new { id = id });
        }
        ...
        public List<T_Order_CouponInfo> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<T_Order_CouponInfo>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<T_Order_CouponInfo> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from I200.dbo.T_Order_CouponInfo ");
        ...
        public List<T_Order_CouponInfo> GetList(int pageIndex, int pageSize, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from I200.dbo.T_Order_CouponInfo T  ");
