...
namespace DAL.Base
{
    ...
    /// T_Goods_Attribute
    /// </summary>
    public class T_Goods_AttributeBaseDAL
    {
        ...
        /// 得到一个对象实体
        /// </summary>
        public T_Goods_Attribute GetModel(int gaId)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select gaId, gaName, gaType, gaRemark, gaTime, gaAlive, accId  ");
            strSql.Append("  from I200.dbo.T_Goods_Attribute ");
            strSql.Append(" where gaId=@gaId");
            return DapperHelper.GetModel<T_Goods_Attribute>(strSql.ToString(), new { gaId = gaId });
        }
        ...
        public List<T_Goods_Attribute> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            strSql.Append(";");
            return DapperHelper.Query<T_Goods_Attribute>(strSql.ToString(), parm).ToList();
        }
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from I200.dbo.T_Goods_Attribute ");
        ...
        public List<T_Goods_Attribute> GetList(int pageIndex, int pageSize, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from I200.dbo.T_Goods_Attribute T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from I200.dbo.T_Goods_Attribute T  ");
