...
namespace DAL.Base
{
    ...
    public class T_OutLinkBaseDAL
    {
        ...
        /// 得到一个对象实体
        /// </summary>
        public T_OutLink GetModel(int id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id, linkClass, PV, EndTime, ShortUrl, linktype, linkurl, remark, ClickCount, CreateTime, managerid, state, linkname  ");
            strSql.Append("  from I200.dbo.T_OutLink ");
            strSql.Append(" where id=@id");
            return DapperHelper.GetModel<T_OutLink>(strSql.ToString(), new { id = id });
        }
        ...
        public List<T_OutLink> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<T_OutLink>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<T_OutLink> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from I200.dbo.T_OutLink ");
        ...
        public List<T_OutLink> GetList(int pageIndex, int pageSize, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from I200.dbo.T_OutLink T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from I200.dbo.T_OutLink T  ");
