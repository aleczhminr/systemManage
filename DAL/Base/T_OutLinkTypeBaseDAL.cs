...
namespace DAL.Base
{
    ...
    /// 推广链接分类
    /// </summary>
    public class T_OutLinkTypeBaseDAL
    {
        ...
        /// 得到一个对象实体
        /// </summary>
        public T_OutLinkType GetModel(int id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id, ot_name, ot_order, ot_id, insTime, insName  ");
            strSql.Append("  from I200.dbo.T_OutLinkType ");
            strSql.Append(" where id=@id");
            return DapperHelper.GetModel<T_OutLinkType>(strSql.ToString(), new { id = id });
        }
        ...
        public List<T_OutLinkType> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<T_OutLinkType>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<T_OutLinkType> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from I200.dbo.T_OutLinkType ");
        ...
        public List<T_OutLinkType> GetList(int pageIndex, int pageSize, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from I200.dbo.T_OutLinkType T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from I200.dbo.T_OutLinkType T  ");
