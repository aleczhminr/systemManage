...
namespace DAL.Base
{
		...
		/// Sys_DayCheck
		/// </summary>
	public  class Sys_DayCheckBaseDAL
	{ 
        /// <summary>
        /// 新增加一条数据
        /// </summary>
        ...
        /// <returns></returns>
        public int Add(Sys_DayCheck model)
        {

            StringBuilder strSql = new StringBuilder();
			strSql.Append("insert into Sys_DayCheck(");			
            strSql.Append("check_type,check_value,checkerid,checktime,check_Item,log_IP,log_Browser");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sys_DayCheck model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Sys_DayCheck set ");
			                                                
            strSql.Append(" check_type = @check_type , ");                                    
            strSql.Append(" check_value = @check_value , ");                                    
            strSql.Append(" checkerid = @checkerid , ");                                    
            strSql.Append(" checktime = @checktime , ");                                    
            strSql.Append(" check_Item = @check_Item , ");                                    
            strSql.Append(" log_IP = @log_IP , ");                                    
            strSql.Append(" log_Browser = @log_Browser  ");            			
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Sys_DayCheck ");
			strSql.Append(" where id=@id");
		...
		/// 得到一个对象实体
		/// </summary>
		public Sys_DayCheck GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, check_type, check_value, checkerid, checktime, check_Item, log_IP, log_Browser  ");			
			strSql.Append("  from Sys_DayCheck ");
			strSql.Append(" where id=@id");
            return  DapperHelper.GetModel<Sys_DayCheck>(strSql.ToString(), new { id  = id  });
		}
        ...
        public List<Sys_DayCheck> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<Sys_DayCheck>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<Sys_DayCheck> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from Sys_DayCheck ");
        ...
        public List<Sys_DayCheck> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from Sys_DayCheck T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from Sys_DayCheck T  ");
