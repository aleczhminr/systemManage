...
namespace DAL.Base
{
		...
		/// Sys_RecordType
		/// </summary>
	public  class Sys_RecordTypeBaseDAL
	{ 
        /// <summary>
        /// 新增加一条数据
        /// </summary>
        ...
        /// <returns></returns>
        public int Add(Sys_RecordType model)
        {

            StringBuilder strSql = new StringBuilder();
			strSql.Append("insert into Sys_RecordType(");			
            strSql.Append("rt_Name,rt_id,insertName,insertTime");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sys_RecordType model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Sys_RecordType set ");
			                                                
            strSql.Append(" rt_Name = @rt_Name , ");                                    
            strSql.Append(" rt_id = @rt_id , ");                                    
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Sys_RecordType ");
			strSql.Append(" where id=@id");
		...
		/// 得到一个对象实体
		/// </summary>
		public Sys_RecordType GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, rt_Name, rt_id, insertName, insertTime  ");			
			strSql.Append("  from Sys_RecordType ");
			strSql.Append(" where id=@id");
            return  DapperHelper.GetModel<Sys_RecordType>(strSql.ToString(), new { id  = id  });
		}
        ...
        public List<Sys_RecordType> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<Sys_RecordType>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<Sys_RecordType> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from Sys_RecordType ");
        ...
        public List<Sys_RecordType> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from Sys_RecordType T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from Sys_RecordType T  ");
