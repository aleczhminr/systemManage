...
namespace DAL.Base
{
    ...
    /// Sys_VisitTagNexus
    /// </summary>
    public class Sys_VisitTagNexusBaseDAL
    {
        /// <summary>
        /// 新增加一条数据
        /// </summary>
        ...
        /// <returns></returns>
        public int Add(Sys_VisitTagNexus model)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into Sys_VisitTagNexus(");
            strSql.Append("tid,vid,insertName,insertTime");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Sys_VisitTagNexus model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update Sys_VisitTagNexus set ");
        ...
        public bool Delete(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from Sys_VisitTagNexus ");
            strSql.Append(" where id=@id");
        ...
        /// 得到一个对象实体
        /// </summary>
        public Sys_VisitTagNexus GetModel(int id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id, tid, vid, insertName, insertTime  ");
            strSql.Append("  from Sys_VisitTagNexus ");
            strSql.Append(" where id=@id");
            return DapperHelper.GetModel<Sys_VisitTagNexus>(strSql.ToString(), new { id = id });
        }
        ...
        public List<Sys_VisitTagNexus> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<Sys_VisitTagNexus>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<Sys_VisitTagNexus> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from Sys_VisitTagNexus ");
        ...
        public List<Sys_VisitTagNexus> GetList(int pageIndex, int pageSize, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from Sys_VisitTagNexus T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from Sys_VisitTagNexus T  ");
