...
namespace DAL.Base
{
		...
		/// SysRpt_ShopActive
		/// </summary>
	public  class SysRpt_ShopActiveBaseDAL
	{ 
        /// <summary>
        /// 新增加一条数据
        /// </summary>
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from SysRpt_ShopActive ");
			strSql.Append(" where id=@id");
		...
		/// 得到一个对象实体
		/// </summary>
		public SysRpt_ShopActive GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, accid, AgentId, regTime, active, maxactive, lastNum, startTime, updatetime, Remark, firstID, stateVal  ");			
			strSql.Append("  from SysRpt_ShopActive ");
			strSql.Append(" where id=@id");
            return  DapperHelper.GetModel<SysRpt_ShopActive>(strSql.ToString(), new { id  = id  });
		}
        ...
        public List<SysRpt_ShopActive> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<SysRpt_ShopActive>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<SysRpt_ShopActive> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from SysRpt_ShopActive ");
        ...
        public List<SysRpt_ShopActive> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from SysRpt_ShopActive T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from SysRpt_ShopActive T  ");
