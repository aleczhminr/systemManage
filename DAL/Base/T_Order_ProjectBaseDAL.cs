...
namespace DAL.Base
{
    ...
    /// T_Order_Project
    /// </summary>
    public class T_Order_ProjectBaseDAL
    {
        ...
        /// 得到一个对象实体
        /// </summary>
        public T_Order_Project GetModel(int busId)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select busId, normalDiscount, standardDiscount, expertDiscount, createDate, startDate, closingDate, additionIntegral, operatorId, operatorIp, operatorTime, projectType, hiddenVal, prefixAgent, allowBuy, displayName, additionDesc, remarkName, payAbleMoney, normalMoney, standardMoney, expertMoney  ");
            strSql.Append("  from I200.dbo.T_Order_Project ");
            strSql.Append(" where busId=@busId");
            return DapperHelper.GetModel<T_Order_Project>(strSql.ToString(), new { busId = busId });
        }
        ...
        public List<T_Order_Project> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<T_Order_Project>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<T_Order_Project> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from I200.dbo.T_Order_Project ");
        ...
        public List<T_Order_Project> GetList(int pageIndex, int pageSize, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from I200.dbo.T_Order_Project T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from I200.dbo.T_Order_Project T  ");
