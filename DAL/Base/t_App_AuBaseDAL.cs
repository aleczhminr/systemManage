...
namespace DAL.Base
{
    ...
    /// 店铺开通功能权限
    /// </summary>
    public class t_App_AuBaseDAL
    { 

        /// <summary>
        /// 得到一个对象实体
        /// </summary>
        public t_App_Au GetModel(int id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id, aa_Status, accid, appkey, appName, stattime, endtime, aa_time, aa_remark, aa_ShortUrl  ");
            strSql.Append("  from I200.dbo.t_App_Au ");
            strSql.Append(" where id=@id");
            return DapperHelper.GetModel<t_App_Au>(strSql.ToString(), new { id = id });
        }
        ...
        public List<t_App_Au> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<t_App_Au>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<t_App_Au> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from I200.dbo.t_App_Au ");
        ...
        public List<t_App_Au> GetList(int pageIndex, int pageSize, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from I200.dbo.t_App_Au T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from I200.dbo.t_App_Au T  ");
