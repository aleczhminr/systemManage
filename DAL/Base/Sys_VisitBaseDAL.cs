...
namespace DAL.Base
{
	...
	{ 
        ...
        /// <returns></returns>
        public int Add(Sys_Visit model)
        {

            StringBuilder strSql = new StringBuilder();
			strSql.Append("insert into Sys_Visit(");			
            strSql.Append("accid,sendType,sendtime,sysType,sendContent,Remark,loginTime,delayDay");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sys_Visit model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Sys_Visit set ");
            ...
            strSql.Append(" delayDay = @delayDay  ");            			
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Sys_Visit ");
			strSql.Append(" where id=@id");
		...
		/// 得到一个对象实体
		/// </summary>
		public Sys_Visit GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, accid, sendType, sendtime, sysType, sendContent, Remark, loginTime, delayDay  ");			
			strSql.Append("  from Sys_Visit ");
			strSql.Append(" where id=@id");
            return  DapperHelper.GetModel<Sys_Visit>(strSql.ToString(), new { id  = id  });
		}
        ...
        public List<Sys_Visit> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<Sys_Visit>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<Sys_Visit> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from Sys_Visit ");
        ...
        public List<Sys_Visit> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from Sys_Visit T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from Sys_Visit T  ");
