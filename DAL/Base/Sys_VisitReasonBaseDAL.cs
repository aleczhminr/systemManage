...
namespace DAL.Base
{
		...
		/// Sys_VisitReason
		/// </summary>
	public  class Sys_VisitReasonBaseDAL
	{ 
        /// <summary>
        /// 新增加一条数据
        /// </summary>
        ...
        /// <returns></returns>
        public int Add(Sys_VisitReason model)
        {

            StringBuilder strSql = new StringBuilder();
			strSql.Append("insert into Sys_VisitReason(");			
            strSql.Append("vr_name,vr_id,insertName,insertTime,vr_state");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sys_VisitReason model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Sys_VisitReason set ");
			                                                
            strSql.Append(" vr_name = @vr_name , ");                                    
            strSql.Append(" vr_id = @vr_id , ");                                    
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Sys_VisitReason ");
			strSql.Append(" where id=@id");
		...
		/// 得到一个对象实体
		/// </summary>
		public Sys_VisitReason GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, vr_name, vr_id, insertName, insertTime, vr_state  ");			
			strSql.Append("  from Sys_VisitReason ");
			strSql.Append(" where id=@id");
            return  DapperHelper.GetModel<Sys_VisitReason>(strSql.ToString(), new { id  = id  });
		}
        ...
        public List<Sys_VisitReason> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<Sys_VisitReason>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<Sys_VisitReason> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from Sys_VisitReason ");
        ...
        public List<Sys_VisitReason> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from Sys_VisitReason T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from Sys_VisitReason T  ");
