...
namespace DAL.Base
{
    ...
    /// 短信列表 
    /// </summary>
    public class T_Sms_ListBaseDAL
    { 
        /// <summary>
        /// 得到一个对象实体
        /// </summary>
        public T_Sms_List GetModel(int id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id, priority, realCnt, notifyID, isFree, errDesc, smsReport, Seqid, IspType, phoneNum, smsContent, sendtime, accID, smsType, smsStatus, smsChannel, userID  ");
            strSql.Append("  from I200.dbo.T_Sms_List ");
            strSql.Append(" where id=@id");
            return DapperHelper.GetModel<T_Sms_List>(strSql.ToString(), new { id = id });
        }
        ...
        public List<T_Sms_List> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<T_Sms_List>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<T_Sms_List> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from I200.dbo.T_Sms_List ");
        ...
        public List<T_Sms_List> GetList(int pageIndex, int pageSize, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from I200.dbo.T_Sms_List T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from I200.dbo.T_Sms_List T  ");
