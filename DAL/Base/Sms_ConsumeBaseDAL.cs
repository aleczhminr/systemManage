...
namespace DAL.Base
{
		...
		/// Sms_Consume
		/// </summary>
	public  class Sms_ConsumeBaseDAL
	{ 
        /// <summary>
        /// 新增加一条数据
        /// </summary>
        ...
        /// <returns></returns>
        public int Add(Sms_Consume model)
        {

            StringBuilder strSql = new StringBuilder();
			strSql.Append("insert into Sms_Consume(");			
            strSql.Append("p_id,c_Num,sms_Surplus,c_name,c_Time,c_remark");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sms_Consume model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Sms_Consume set ");
			                                                
            strSql.Append(" p_id = @p_id , ");                                    
            strSql.Append(" c_Num = @c_Num , ");                                    
            strSql.Append(" sms_Surplus = @sms_Surplus , ");                                    
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Sms_Consume ");
			strSql.Append(" where id=@id");
		...
		/// 得到一个对象实体
		/// </summary>
		public Sms_Consume GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, p_id, c_Num, sms_Surplus, c_name, c_Time, c_remark  ");			
			strSql.Append("  from Sms_Consume ");
			strSql.Append(" where id=@id");
            return  DapperHelper.GetModel<Sms_Consume>(strSql.ToString(), new { id  = id  });
		}
        ...
        public List<Sms_Consume> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<Sms_Consume>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<Sms_Consume> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from Sms_Consume ");
        ...
        public List<Sms_Consume> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from Sms_Consume T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from Sms_Consume T  ");
