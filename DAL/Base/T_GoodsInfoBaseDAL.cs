...
namespace DAL.Base
{
    ...
    /// 商品信息
    /// </summary>
    public class T_GoodsInfoBaseDAL
    { 
        ...
        /// 得到一个对象实体
        /// </summary>
        public T_GoodsInfo GetModel(int gid)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select gid, gName, gQuantity, gDiscount, gSpecification, gPrice, gCostPrice, gAddTime, gBarcode, gRemark, gPicUrl, accID, gPY, gPinYin, gUnionKey, gInsertDate, gOperatorID, gCheckDate, IsExtend, isService, isDown, isDownTime, gMaxName, gMaxID, gMinName, gMinID  ");
            strSql.Append("  from I200.dbo.T_GoodsInfo ");
            strSql.Append(" where gid=@gid");
            return DapperHelper.GetModel<T_GoodsInfo>(strSql.ToString(), new { gid = gid });
        }
        ...
        public List<T_GoodsInfo> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<T_GoodsInfo>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<T_GoodsInfo> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from I200.dbo.T_GoodsInfo ");
        ...
        public List<T_GoodsInfo> GetList(int pageIndex, int pageSize, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from I200.dbo.T_GoodsInfo T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from I200.dbo.T_GoodsInfo T  ");
