...
namespace DAL.Base
{
	...
	{ 
        ...
        /// <returns></returns>
        public int Add(EmailType model)
        {

            StringBuilder strSql = new StringBuilder();
			strSql.Append("insert into EmailType(");			
            strSql.Append("typeName,sendType");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(EmailType model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update EmailType set ");
		...
		/// 得到一个对象实体
		/// </summary>
		public EmailType GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, typeName, sendType  ");			
			strSql.Append("  from EmailType ");
			strSql.Append(" where id=@id");
            return  DapperHelper.GetModel<EmailType>(strSql.ToString(), new { id  = id  });
		}
        ...
        public List<EmailType> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<EmailType>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<EmailType> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from EmailType ");
        ...
        public List<EmailType> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from EmailType T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from EmailType T  ");
