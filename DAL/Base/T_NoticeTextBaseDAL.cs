...
namespace DAL.Base
{
    ...
    /// T_NoticeText
    /// </summary>
    public class T_NoticeTextBaseDAL
    {
        ...
        /// 得到一个对象实体
        /// </summary>
        public T_NoticeText GetModel(int id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id, nType, nDisplay, nTitle, nContent, nTime, nOperatorName, nOperatorIp  ");
            strSql.Append("  from I200.dbo.T_NoticeText ");
            strSql.Append(" where id=@id");
            return DapperHelper.GetModel<T_NoticeText>(strSql.ToString(), new { id = id });
        }
        ...
        public List<T_NoticeText> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<T_NoticeText>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<T_NoticeText> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from I200.dbo.T_NoticeText ");
        ...
        public List<T_NoticeText> GetList(int pageIndex, int pageSize, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from I200.dbo.T_NoticeText T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from I200.dbo.T_NoticeText T  ");
