...
namespace DAL.Base
{
		...
		/// Sys_TagNexus
		/// </summary>
	public  class Sys_TagNexusBaseDAL
	{ 
        /// <summary>
        /// 新增加一条数据
        /// </summary>
        ...
        /// <returns></returns>
        public int Add(Sys_TagNexus model)
        {
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sys_TagNexus model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Sys_TagNexus set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Sys_TagNexus ");
			strSql.Append(" where id=@id");
		...
		/// 得到一个对象实体
		/// </summary>
		public Sys_TagNexus GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, tag_id, acc_id, insertName, insertTime  ");			
			strSql.Append("  from Sys_TagNexus ");
			strSql.Append(" where id=@id");
            return  DapperHelper.GetModel<Sys_TagNexus>(strSql.ToString(), new { id  = id  });
		}
        ...
        public List<Sys_TagNexus> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<Sys_TagNexus>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<Sys_TagNexus> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from Sys_TagNexus ");
        ...
        public List<Sys_TagNexus> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from Sys_TagNexus T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from Sys_TagNexus T  ");
