...
namespace DAL.Base
{
		...
		/// Sys_SysAreaData4Echarts
		/// </summary>
	public  class Sys_SysAreaData4EchartsBaseDAL
	{ 
        /// <summary>
        /// 新增加一条数据
        /// </summary>
        ...
        /// <returns></returns>
        public int Add(Sys_SysAreaData4Echarts model)
        {

            StringBuilder strSql = new StringBuilder();
			strSql.Append("insert into Sys_SysAreaData4Echarts(");			
            strSql.Append("recDate,areaID,areaName,regCnt,MemberCnt,saleCnt,payCnt,smsCnt,orderSum,UserActiveCnt,UserLoginCnt,UserSleepCnt,UserLostCnt,prov_name");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sys_SysAreaData4Echarts model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Sys_SysAreaData4Echarts set ");
            ...
            strSql.Append(" prov_name = @prov_name  ");            			
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Sys_SysAreaData4Echarts ");
			strSql.Append(" where id=@id");
		...
		/// 得到一个对象实体
		/// </summary>
		public Sys_SysAreaData4Echarts GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, recDate, areaID, areaName, regCnt, MemberCnt, saleCnt, payCnt, smsCnt, orderSum, UserActiveCnt, UserLoginCnt, UserSleepCnt, UserLostCnt, prov_name  ");			
			strSql.Append("  from Sys_SysAreaData4Echarts ");
			strSql.Append(" where id=@id");
            return  DapperHelper.GetModel<Sys_SysAreaData4Echarts>(strSql.ToString(), new { id  = id  });
		}
        ...
        public List<Sys_SysAreaData4Echarts> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<Sys_SysAreaData4Echarts>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<Sys_SysAreaData4Echarts> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from Sys_SysAreaData4Echarts ");
        ...
        public List<Sys_SysAreaData4Echarts> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from Sys_SysAreaData4Echarts T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from Sys_SysAreaData4Echarts T  ");
