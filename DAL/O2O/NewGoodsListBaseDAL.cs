...
namespace DAL.O2O
{
    ...
    /// NewGoodsList
    /// </summary>
    public class NewGoodsListBaseDAL
    {
        ...
        /// 得到一个对象实体
        /// </summary>
        public NewGoodsList GetModel(int id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id, price, lastSalePrice, cosPrice, saleNum, saleMoney, userNum, retailNum, isPic, gid, accid, ygid, accountName, gname, maxClass, minClass, goodsNum  ");
            strSql.Append("  from OTwoO.dbo.NewGoodsList ");
            strSql.Append(" where id=@id");
            return DapperHelper.GetModel<NewGoodsList>(strSql.ToString(), new { id = id });
        }
        ...
        public List<NewGoodsList> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<NewGoodsList>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<NewGoodsList> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from OTwoO.dbo.NewGoodsList ");
        ...
        public List<NewGoodsList> GetList(int pageIndex, int pageSize, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from OTwoO.dbo.NewGoodsList T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from OTwoO.dbo.NewGoodsList T  ");
