...
namespace DAL.O2O
{
    ...
    public class goodsPicBaseDAL
    {
        ...
        /// 得到一个对象实体
        /// </summary>
        public goodsPic GetModel(int id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id, gid, ygid, picUrl, picOrder  ");
            strSql.Append("  from OTwoO.dbo.goodsPic ");
            strSql.Append(" where id=@id");
            return DapperHelper.GetModel<goodsPic>(strSql.ToString(), new { id = id });
        }
        ...
        public List<goodsPic> GetList(List<DapperWhere> dapperWheres)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            return DapperHelper.Query<goodsPic>(strSql.ToString(), parm).ToList();
        }
        ...
        public List<goodsPic> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public int GetCount(List<DapperWhere> dapperWheres)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select count(*) from OTwoO.dbo.goodsPic ");
        ...
        public List<goodsPic> GetList(int pageIndex, int pageSize, List<DapperWhere> dapperWheres, string filedOrder)
        {
            StringBuilder strSql = new StringBuilder();
            string where = "";
            Dictionary<string, object> parm = new Dictionary<string, object>();
            ...
            strSql.Append(" )AS Row, * from OTwoO.dbo.goodsPic T  ");
        ...
        public List<T> GetList<T>(int pageIndex, int pageSize, string columnName, List<DapperWhere> dapperWheres, string filedOrder)
        {
            ...
            strSql.Append(" )AS overRow, " + columnName + " from OTwoO.dbo.goodsPic T  ");
