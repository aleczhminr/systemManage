...
(function (factory) {
    ...
    var settings = {
        ...
        options: {
            ...
            toolbar: [
              ...
              ['view', ['codeview']],
              ['style', ['style']],
              ['font', ['bold', 'italic']], ['height', ['height']],
    ...
    var Renderer = function () {
        ...
        var tplShortcutText = function (lang) {
            var body = '<tr><td>鈱� + B</td><td>' + lang.font.bold + '</td></tr>' +
                       '<tr><td>鈱� + I</td><td>' + lang.font.italic + '</td></tr>' +
                       '<tr><td>鈱� + U</td><td>' + lang.font.underline + '</td></tr>' +
                       '<tr><td>鈱� + 鈬� + S</td><td>' + lang.font.strikethrough + '</td></tr>' +
        ...
        var tplShortcutAction = function (lang) {
            var body = '<tr><td>鈱� + Z</td><td>' + lang.history.undo + '</td></tr>' +
        ...
        var tplShortcutPara = function (lang) {
            var body = '<tr><td>鈱� + 鈬� + L</td><td>' + lang.paragraph.left + '</td></tr>' +
        ...
        var tplShortcutStyle = function (lang) {
            var body = '<tr><td>鈱� + NUM0</td><td>' + lang.style.normal + '</td></tr>' +
        ...
        var tplDialogs = function (lang, options) {
            ...
            var tplHelpDialog = function () {
                var body = '<a class="modal-close pull-right" aria-hidden="true" tabindex="-1">' + lang.shortcut.close + '</a>' +
                           ...
                           '<p class="text-center">' +
                             '<a href="//hackerwins.github.io/summernote/" target="_blank">Summernote 0.5.9</a> 路 ' +
                             '<a href="//github.com/HackerWins/summernote" target="_blank">Project</a> 路 ' +
        ...
        var representShortcut = function (str) {
            if (agent.isMac) {
                str = str.replace('CMD', '鈱�').replace('SHIFT', '鈬�');
            }
