...
{
    //NewGoodsList
    public static class NewGoodsListBaseBLL
    {
        ...
        /// 得到一个对象实体
        /// </summary>
        public static NewGoodsList GetModel(int id)
        {
            NewGoodsListBaseDAL dal = new NewGoodsListBaseDAL();
        ...
        public static List<NewGoodsList> GetList(List<DapperWhere> dapperWheres)
        {
            NewGoodsListBaseDAL dal = new NewGoodsListBaseDAL();
        ...
        public static List<NewGoodsList> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            NewGoodsListBaseDAL dal = new NewGoodsListBaseDAL();
        ...
        public static List<NewGoodsList> GetList(int pageIndex, int pageSize, List<DapperWhere> dapperWheres, string filedOrder)
        {
            NewGoodsListBaseDAL dal = new NewGoodsListBaseDAL();
