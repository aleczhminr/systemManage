...
{
	 	//Sms_Recharge
		public static class Sms_RechargeBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(Sms_Recharge model)
		{   
		 Sms_RechargeBaseDAL dal=new Sms_RechargeBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(Sms_Recharge model)
        {
		 Sms_RechargeBaseDAL dal=new Sms_RechargeBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sms_Recharge GetModel(int id){
        Sms_RechargeBaseDAL dal=new Sms_RechargeBaseDAL();
        ...
        public static List<Sms_Recharge> GetList(List<DapperWhere> dapperWheres)
        {
        	Sms_RechargeBaseDAL dal=new Sms_RechargeBaseDAL();
        ...
        public static List<Sms_Recharge> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	Sms_RechargeBaseDAL dal=new Sms_RechargeBaseDAL();
        ...
        public static List<Sms_Recharge> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	Sms_RechargeBaseDAL dal=new Sms_RechargeBaseDAL();
