...
{
	 	//Sys_VisitReason
		public static class Sys_VisitReasonBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(Sys_VisitReason model)
		{   
		 Sys_VisitReasonBaseDAL dal=new Sys_VisitReasonBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(Sys_VisitReason model)
        {
		 Sys_VisitReasonBaseDAL dal=new Sys_VisitReasonBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sys_VisitReason GetModel(int id){
        Sys_VisitReasonBaseDAL dal=new Sys_VisitReasonBaseDAL();
        ...
        public static List<Sys_VisitReason> GetList(List<DapperWhere> dapperWheres)
        {
        	Sys_VisitReasonBaseDAL dal=new Sys_VisitReasonBaseDAL();
        ...
        public static List<Sys_VisitReason> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	Sys_VisitReasonBaseDAL dal=new Sys_VisitReasonBaseDAL();
        ...
        public static List<Sys_VisitReason> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	Sys_VisitReasonBaseDAL dal=new Sys_VisitReasonBaseDAL();
