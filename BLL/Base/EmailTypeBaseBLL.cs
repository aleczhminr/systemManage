...
{
	 	//EmailType
		public static class EmailTypeBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(EmailType model)
		{   
		 EmailTypeBaseDAL dal=new EmailTypeBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(EmailType model)
        {
		 EmailTypeBaseDAL dal=new EmailTypeBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static EmailType GetModel(int id){
        EmailTypeBaseDAL dal=new EmailTypeBaseDAL();
        ...
        public static List<EmailType> GetList(List<DapperWhere> dapperWheres)
        {
        	EmailTypeBaseDAL dal=new EmailTypeBaseDAL();
        ...
        public static List<EmailType> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	EmailTypeBaseDAL dal=new EmailTypeBaseDAL();
        ...
        public static List<EmailType> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	EmailTypeBaseDAL dal=new EmailTypeBaseDAL();
