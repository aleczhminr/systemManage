...
namespace BLL.Base
{
    ...
    /// 支出信息
    /// </summary>
    public static class t_PayRecordBaseBLL
    {
        #region  Method
        /// <summary>
        /// 得到一个对象实体
        /// </summary>
        public static t_PayRecord GetModel(long ID)
        {
            t_PayRecordBaseDAL dal = new t_PayRecordBaseDAL();
        ...
        public static List<t_PayRecord> GetList(List<DapperWhere> dapperWheres)
        {
            t_PayRecordBaseDAL dal = new t_PayRecordBaseDAL();
        ...
        public static List<t_PayRecord> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            t_PayRecordBaseDAL dal = new t_PayRecordBaseDAL();
        ...
        public static List<t_PayRecord> GetList(int pageIndex, int pageSize, List<DapperWhere> dapperWheres, string filedOrder)
        {
            t_PayRecordBaseDAL dal = new t_PayRecordBaseDAL();
