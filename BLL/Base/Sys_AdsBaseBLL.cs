...
{
	 	//Sys_Ads
		public static class Sys_AdsBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(Sys_Ads model)
		{   
		 Sys_AdsBaseDAL dal=new Sys_AdsBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(Sys_Ads model)
        {
		 Sys_AdsBaseDAL dal=new Sys_AdsBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sys_Ads GetModel(int id){
        Sys_AdsBaseDAL dal=new Sys_AdsBaseDAL();
        ...
        public static List<Sys_Ads> GetList(List<DapperWhere> dapperWheres)
        {
        	Sys_AdsBaseDAL dal=new Sys_AdsBaseDAL();
        ...
        public static List<Sys_Ads> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	Sys_AdsBaseDAL dal=new Sys_AdsBaseDAL();
        ...
        public static List<Sys_Ads> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	Sys_AdsBaseDAL dal=new Sys_AdsBaseDAL();
