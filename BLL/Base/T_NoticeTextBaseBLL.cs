...
{
    //T_NoticeText
    public static class T_NoticeTextBaseBLL
    {
        ...
        /// 得到一个对象实体
        /// </summary>
        public static T_NoticeText GetModel(int id)
        {
            T_NoticeTextBaseDAL dal = new T_NoticeTextBaseDAL();
        ...
        public static List<T_NoticeText> GetList(List<DapperWhere> dapperWheres)
        {
            T_NoticeTextBaseDAL dal = new T_NoticeTextBaseDAL();
        ...
        public static List<T_NoticeText> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            T_NoticeTextBaseDAL dal = new T_NoticeTextBaseDAL();
        ...
        public static List<T_NoticeText> GetList(int pageIndex, int pageSize, List<DapperWhere> dapperWheres, string filedOrder)
        {
            T_NoticeTextBaseDAL dal = new T_NoticeTextBaseDAL();
