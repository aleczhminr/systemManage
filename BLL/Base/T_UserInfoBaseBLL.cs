...
{
	 	//T_UserInfo
		public static class T_UserInfoBaseBLL
	{
        ...
        /// 得到一个对象实体
        /// </summary>
        public static T_UserInfo GetModel(long uid){
        T_UserInfoBaseDAL dal=new T_UserInfoBaseDAL();
        ...
        public static List<T_UserInfo> GetList(List<DapperWhere> dapperWheres)
        {
        	T_UserInfoBaseDAL dal=new T_UserInfoBaseDAL();
        ...
        public static List<T_UserInfo> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	T_UserInfoBaseDAL dal=new T_UserInfoBaseDAL();
        ...
        public static List<T_UserInfo> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	T_UserInfoBaseDAL dal=new T_UserInfoBaseDAL();
