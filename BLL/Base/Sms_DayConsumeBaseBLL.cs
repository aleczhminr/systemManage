...
{
	 	//Sms_DayConsume
		public static class Sms_DayConsumeBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(Sms_DayConsume model)
		{   
		 Sms_DayConsumeBaseDAL dal=new Sms_DayConsumeBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(Sms_DayConsume model)
        {
		 Sms_DayConsumeBaseDAL dal=new Sms_DayConsumeBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sms_DayConsume GetModel(int id){
        Sms_DayConsumeBaseDAL dal=new Sms_DayConsumeBaseDAL();
        ...
        public static List<Sms_DayConsume> GetList(List<DapperWhere> dapperWheres)
        {
        	Sms_DayConsumeBaseDAL dal=new Sms_DayConsumeBaseDAL();
        ...
        public static List<Sms_DayConsume> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	Sms_DayConsumeBaseDAL dal=new Sms_DayConsumeBaseDAL();
        ...
        public static List<Sms_DayConsume> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	Sms_DayConsumeBaseDAL dal=new Sms_DayConsumeBaseDAL();
