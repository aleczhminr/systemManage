...
{
	 	//Sys_VisitReply
		public static class Sys_VisitReplyBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(Sys_VisitReply model)
		{   
		 Sys_VisitReplyBaseDAL dal=new Sys_VisitReplyBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(Sys_VisitReply model)
        {
		 Sys_VisitReplyBaseDAL dal=new Sys_VisitReplyBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sys_VisitReply GetModel(int id){
        Sys_VisitReplyBaseDAL dal=new Sys_VisitReplyBaseDAL();
        ...
        public static List<Sys_VisitReply> GetList(List<DapperWhere> dapperWheres)
        {
        	Sys_VisitReplyBaseDAL dal=new Sys_VisitReplyBaseDAL();
        ...
        public static List<Sys_VisitReply> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	Sys_VisitReplyBaseDAL dal=new Sys_VisitReplyBaseDAL();
        ...
        public static List<Sys_VisitReply> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	Sys_VisitReplyBaseDAL dal=new Sys_VisitReplyBaseDAL();
