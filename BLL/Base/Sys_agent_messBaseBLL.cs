...
{
	 	//Sys_agent_mess
		public static class Sys_agent_messBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(Sys_agent_mess model)
		{   
		 Sys_agent_messBaseDAL dal=new Sys_agent_messBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(Sys_agent_mess model)
        {
		 Sys_agent_messBaseDAL dal=new Sys_agent_messBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sys_agent_mess GetModel(int ID){
        Sys_agent_messBaseDAL dal=new Sys_agent_messBaseDAL();
        ...
        public static List<Sys_agent_mess> GetList(List<DapperWhere> dapperWheres)
        {
        	Sys_agent_messBaseDAL dal=new Sys_agent_messBaseDAL();
        ...
        public static List<Sys_agent_mess> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	Sys_agent_messBaseDAL dal=new Sys_agent_messBaseDAL();
        ...
        public static List<Sys_agent_mess> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	Sys_agent_messBaseDAL dal=new Sys_agent_messBaseDAL();
