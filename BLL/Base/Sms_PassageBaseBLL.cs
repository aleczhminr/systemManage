...
{
	 	//Sms_Passage
		public static class Sms_PassageBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(Sms_Passage model)
		{   
		 Sms_PassageBaseDAL dal=new Sms_PassageBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(Sms_Passage model)
        {
		 Sms_PassageBaseDAL dal=new Sms_PassageBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sms_Passage GetModel(int id){
        Sms_PassageBaseDAL dal=new Sms_PassageBaseDAL();
        ...
        public static List<Sms_Passage> GetList(List<DapperWhere> dapperWheres)
        {
        	Sms_PassageBaseDAL dal=new Sms_PassageBaseDAL();
        ...
        public static List<Sms_Passage> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	Sms_PassageBaseDAL dal=new Sms_PassageBaseDAL();
        ...
        public static List<Sms_Passage> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	Sms_PassageBaseDAL dal=new Sms_PassageBaseDAL();
