...
namespace BLL.Base
{
		...
		public static class Sys_SysAreaData4EchartsBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(Sys_SysAreaData4Echarts model)
		{   
		 Sys_SysAreaData4EchartsBaseDAL dal=new Sys_SysAreaData4EchartsBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(Sys_SysAreaData4Echarts model)
        {
		 Sys_SysAreaData4EchartsBaseDAL dal=new Sys_SysAreaData4EchartsBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sys_SysAreaData4Echarts GetModel(int id){
        Sys_SysAreaData4EchartsBaseDAL dal=new Sys_SysAreaData4EchartsBaseDAL();
        ...
        public static List<Sys_SysAreaData4Echarts> GetList(List<DapperWhere> dapperWheres)
        {
        	Sys_SysAreaData4EchartsBaseDAL dal=new Sys_SysAreaData4EchartsBaseDAL();
        ...
        public static List<Sys_SysAreaData4Echarts> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	Sys_SysAreaData4EchartsBaseDAL dal=new Sys_SysAreaData4EchartsBaseDAL();
        ...
        public static List<Sys_SysAreaData4Echarts> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	Sys_SysAreaData4EchartsBaseDAL dal=new Sys_SysAreaData4EchartsBaseDAL();
