...
{
	 	//T_Order_CouponList
		public static class T_Order_CouponListBaseBLL
	{
        ...
        /// 得到一个对象实体
        /// </summary>
        public static T_Order_CouponList GetModel(int id){
        T_Order_CouponListBaseDAL dal=new T_Order_CouponListBaseDAL();
        ...
        public static List<T_Order_CouponList> GetList(List<DapperWhere> dapperWheres)
        {
        	T_Order_CouponListBaseDAL dal=new T_Order_CouponListBaseDAL();
        ...
        public static List<T_Order_CouponList> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	T_Order_CouponListBaseDAL dal=new T_Order_CouponListBaseDAL();
        ...
        public static List<T_Order_CouponList> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	T_Order_CouponListBaseDAL dal=new T_Order_CouponListBaseDAL();
