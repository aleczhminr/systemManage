...
{
	 	//Sys_VisitEmailSnap
		public static class Sys_VisitEmailSnapBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(Sys_VisitEmailSnap model)
		{   
		 Sys_VisitEmailSnapBaseDAL dal=new Sys_VisitEmailSnapBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(Sys_VisitEmailSnap model)
        {
		 Sys_VisitEmailSnapBaseDAL dal=new Sys_VisitEmailSnapBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sys_VisitEmailSnap GetModel(int id){
        Sys_VisitEmailSnapBaseDAL dal=new Sys_VisitEmailSnapBaseDAL();
        ...
        public static List<Sys_VisitEmailSnap> GetList(List<DapperWhere> dapperWheres)
        {
        	Sys_VisitEmailSnapBaseDAL dal=new Sys_VisitEmailSnapBaseDAL();
        ...
        public static List<Sys_VisitEmailSnap> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	Sys_VisitEmailSnapBaseDAL dal=new Sys_VisitEmailSnapBaseDAL();
        ...
        public static List<Sys_VisitEmailSnap> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	Sys_VisitEmailSnapBaseDAL dal=new Sys_VisitEmailSnapBaseDAL();
