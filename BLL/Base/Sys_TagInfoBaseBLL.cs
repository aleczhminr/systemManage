...
{
	 	//Sys_TagInfo
		public static class Sys_TagInfoBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(Sys_TagInfo model)
		{   
		 Sys_TagInfoBaseDAL dal=new Sys_TagInfoBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(Sys_TagInfo model)
        {
		 Sys_TagInfoBaseDAL dal=new Sys_TagInfoBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sys_TagInfo GetModel(int id){
        Sys_TagInfoBaseDAL dal=new Sys_TagInfoBaseDAL();
        ...
        public static List<Sys_TagInfo> GetList(List<DapperWhere> dapperWheres)
        {
        	Sys_TagInfoBaseDAL dal=new Sys_TagInfoBaseDAL();
        ...
        public static List<Sys_TagInfo> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	Sys_TagInfoBaseDAL dal=new Sys_TagInfoBaseDAL();
        ...
        public static List<Sys_TagInfo> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	Sys_TagInfoBaseDAL dal=new Sys_TagInfoBaseDAL();
