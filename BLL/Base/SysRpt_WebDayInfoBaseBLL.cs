...
{
	 	//SysRpt_WebDayInfo
		public static class SysRpt_WebDayInfoBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(SysRpt_WebDayInfo model)
		{   
		 SysRpt_WebDayInfoBaseDAL dal=new SysRpt_WebDayInfoBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(SysRpt_WebDayInfo model)
        {
		 SysRpt_WebDayInfoBaseDAL dal=new SysRpt_WebDayInfoBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static SysRpt_WebDayInfo GetModel(int id){
        SysRpt_WebDayInfoBaseDAL dal=new SysRpt_WebDayInfoBaseDAL();
        ...
        public static List<SysRpt_WebDayInfo> GetList(List<DapperWhere> dapperWheres)
        {
        	SysRpt_WebDayInfoBaseDAL dal=new SysRpt_WebDayInfoBaseDAL();
        ...
        public static List<SysRpt_WebDayInfo> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	SysRpt_WebDayInfoBaseDAL dal=new SysRpt_WebDayInfoBaseDAL();
        ...
        public static List<SysRpt_WebDayInfo> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	SysRpt_WebDayInfoBaseDAL dal=new SysRpt_WebDayInfoBaseDAL();
