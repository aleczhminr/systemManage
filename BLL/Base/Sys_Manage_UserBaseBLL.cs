...
{
	 	//Sys_Manage_User
		public static class Sys_Manage_UserBaseBLL
	{
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sys_Manage_User GetModel(int Id){
        Sys_Manage_UserBaseDAL dal=new Sys_Manage_UserBaseDAL();
        ...
        public static List<Sys_Manage_User> GetList(List<DapperWhere> dapperWheres)
        {
        	Sys_Manage_UserBaseDAL dal=new Sys_Manage_UserBaseDAL();
        ...
        public static List<Sys_Manage_User> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	Sys_Manage_UserBaseDAL dal=new Sys_Manage_UserBaseDAL();
        ...
        public static List<Sys_Manage_User> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	Sys_Manage_UserBaseDAL dal=new Sys_Manage_UserBaseDAL();
