...
{
	 	//Sys_RecordType
		public static class Sys_RecordTypeBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(Sys_RecordType model)
		{   
		 Sys_RecordTypeBaseDAL dal=new Sys_RecordTypeBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(Sys_RecordType model)
        {
		 Sys_RecordTypeBaseDAL dal=new Sys_RecordTypeBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sys_RecordType GetModel(int id){
        Sys_RecordTypeBaseDAL dal=new Sys_RecordTypeBaseDAL();
        ...
        public static List<Sys_RecordType> GetList(List<DapperWhere> dapperWheres)
        {
        	Sys_RecordTypeBaseDAL dal=new Sys_RecordTypeBaseDAL();
        ...
        public static List<Sys_RecordType> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	Sys_RecordTypeBaseDAL dal=new Sys_RecordTypeBaseDAL();
        ...
        public static List<Sys_RecordType> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	Sys_RecordTypeBaseDAL dal=new Sys_RecordTypeBaseDAL();
