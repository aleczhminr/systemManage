...
{
	 	//SysRpt_ShopInfo
		public static class SysRpt_ShopInfoBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(SysRpt_ShopInfo model)
		{   
		 SysRpt_ShopInfoBaseDAL dal=new SysRpt_ShopInfoBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(SysRpt_ShopInfo model)
        {
		 SysRpt_ShopInfoBaseDAL dal=new SysRpt_ShopInfoBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static SysRpt_ShopInfo GetModel(int id){
        SysRpt_ShopInfoBaseDAL dal=new SysRpt_ShopInfoBaseDAL();
        ...
        public static List<SysRpt_ShopInfo> GetList(List<DapperWhere> dapperWheres)
        {
        	SysRpt_ShopInfoBaseDAL dal=new SysRpt_ShopInfoBaseDAL();
        ...
        public static List<SysRpt_ShopInfo> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	SysRpt_ShopInfoBaseDAL dal=new SysRpt_ShopInfoBaseDAL();
        ...
        public static List<SysRpt_ShopInfo> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	SysRpt_ShopInfoBaseDAL dal=new SysRpt_ShopInfoBaseDAL();
