...
{
    //Sys_VisitTag
    public static class Sys_VisitTagBaseBLL
    {
        ...
        /// <returns></returns>
        public static int Add(Sys_VisitTag model)
        {
            Sys_VisitTagBaseDAL dal = new Sys_VisitTagBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(Sys_VisitTag model)
        {
            Sys_VisitTagBaseDAL dal = new Sys_VisitTagBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sys_VisitTag GetModel(int id)
        {
            Sys_VisitTagBaseDAL dal = new Sys_VisitTagBaseDAL();
        ...
        public static List<Sys_VisitTag> GetList(List<DapperWhere> dapperWheres)
        {
            Sys_VisitTagBaseDAL dal = new Sys_VisitTagBaseDAL();
        ...
        public static List<Sys_VisitTag> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            Sys_VisitTagBaseDAL dal = new Sys_VisitTagBaseDAL();
        ...
        public static List<Sys_VisitTag> GetList(int pageIndex, int pageSize, List<DapperWhere> dapperWheres, string filedOrder)
        {
            Sys_VisitTagBaseDAL dal = new Sys_VisitTagBaseDAL();
