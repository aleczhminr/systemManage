...
{
    //T_LOG
    public static class T_LOGBaseBLL
    {
        ...
        /// 得到一个对象实体
        /// </summary>
        public static T_LOG GetModel(int ID)
        {
            T_LOGBaseDAL dal = new T_LOGBaseDAL();
        ...
        public static List<T_LOG> GetList(List<DapperWhere> dapperWheres)
        {
            T_LOGBaseDAL dal = new T_LOGBaseDAL();
        ...
        public static List<T_LOG> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder)
        {
            T_LOGBaseDAL dal = new T_LOGBaseDAL();
        ...
        public static List<T_LOG> GetList(int pageIndex, int pageSize, List<DapperWhere> dapperWheres, string filedOrder)
        {
            T_LOGBaseDAL dal = new T_LOGBaseDAL();
