...
namespace BLL.Base
{
		...
		public static class Sys_ProvinceCityListBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(Sys_ProvinceCityList model)
		{   
		 Sys_ProvinceCityListBaseDAL dal=new Sys_ProvinceCityListBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(Sys_ProvinceCityList model)
        {
		 Sys_ProvinceCityListBaseDAL dal=new Sys_ProvinceCityListBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sys_ProvinceCityList GetModel(int id){
        Sys_ProvinceCityListBaseDAL dal=new Sys_ProvinceCityListBaseDAL();
        ...
        public static List<Sys_ProvinceCityList> GetList(List<DapperWhere> dapperWheres)
        {
        	Sys_ProvinceCityListBaseDAL dal=new Sys_ProvinceCityListBaseDAL();
        ...
        public static List<Sys_ProvinceCityList> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	Sys_ProvinceCityListBaseDAL dal=new Sys_ProvinceCityListBaseDAL();
        ...
        public static List<Sys_ProvinceCityList> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	Sys_ProvinceCityListBaseDAL dal=new Sys_ProvinceCityListBaseDAL();
