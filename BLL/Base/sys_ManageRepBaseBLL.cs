...
{
	 	//sys_ManageRep
		public static class sys_ManageRepBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(sys_ManageRep model)
		{   
		 sys_ManageRepBaseDAL dal=new sys_ManageRepBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(sys_ManageRep model)
        {
		 sys_ManageRepBaseDAL dal=new sys_ManageRepBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static sys_ManageRep GetModel(int id){
        sys_ManageRepBaseDAL dal=new sys_ManageRepBaseDAL();
        ...
        public static List<sys_ManageRep> GetList(List<DapperWhere> dapperWheres)
        {
        	sys_ManageRepBaseDAL dal=new sys_ManageRepBaseDAL();
        ...
        public static List<sys_ManageRep> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	sys_ManageRepBaseDAL dal=new sys_ManageRepBaseDAL();
        ...
        public static List<sys_ManageRep> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	sys_ManageRepBaseDAL dal=new sys_ManageRepBaseDAL();
