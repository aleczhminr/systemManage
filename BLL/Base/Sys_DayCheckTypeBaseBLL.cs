...
{
	 	//Sys_DayCheckType
		public static class Sys_DayCheckTypeBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(Sys_DayCheckType model)
		{   
		 Sys_DayCheckTypeBaseDAL dal=new Sys_DayCheckTypeBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(Sys_DayCheckType model)
        {
		 Sys_DayCheckTypeBaseDAL dal=new Sys_DayCheckTypeBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sys_DayCheckType GetModel(int id){
        Sys_DayCheckTypeBaseDAL dal=new Sys_DayCheckTypeBaseDAL();
        ...
        public static List<Sys_DayCheckType> GetList(List<DapperWhere> dapperWheres)
        {
        	Sys_DayCheckTypeBaseDAL dal=new Sys_DayCheckTypeBaseDAL();
        ...
        public static List<Sys_DayCheckType> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	Sys_DayCheckTypeBaseDAL dal=new Sys_DayCheckTypeBaseDAL();
        ...
        public static List<Sys_DayCheckType> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	Sys_DayCheckTypeBaseDAL dal=new Sys_DayCheckTypeBaseDAL();
