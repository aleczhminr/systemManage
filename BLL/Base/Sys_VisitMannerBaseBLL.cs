...
{
	 	//Sys_VisitManner
		public static class Sys_VisitMannerBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(Sys_VisitManner model)
		{   
		 Sys_VisitMannerBaseDAL dal=new Sys_VisitMannerBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(Sys_VisitManner model)
        {
		 Sys_VisitMannerBaseDAL dal=new Sys_VisitMannerBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sys_VisitManner GetModel(int id){
        Sys_VisitMannerBaseDAL dal=new Sys_VisitMannerBaseDAL();
        ...
        public static List<Sys_VisitManner> GetList(List<DapperWhere> dapperWheres)
        {
        	Sys_VisitMannerBaseDAL dal=new Sys_VisitMannerBaseDAL();
        ...
        public static List<Sys_VisitManner> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	Sys_VisitMannerBaseDAL dal=new Sys_VisitMannerBaseDAL();
        ...
        public static List<Sys_VisitManner> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	Sys_VisitMannerBaseDAL dal=new Sys_VisitMannerBaseDAL();
