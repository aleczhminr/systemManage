...
{
    //Sys_VisitTagNexus
    public static class Sys_VisitTagNexusBaseBLL
    {
        ...
        public static List<Sys_VisitTagNexus> GetList(List<DapperWhere> dapperWheres)
        {
            Sys_VisitTagNexusBaseDAL dal = new Sys_VisitTagNexusBaseDAL();
        ...
        public static List<Sys_VisitTagNexus> GetList(int pageIndex, int pageSize, List<DapperWhere> dapperWheres, string filedOrder)
        {
            Sys_VisitTagNexusBaseDAL dal = new Sys_VisitTagNexusBaseDAL();
