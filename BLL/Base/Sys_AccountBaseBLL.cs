...
{
	 	//Sys_Account
		public static class Sys_AccountBaseBLL
	{
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sys_Account GetModel(int id){
        Sys_AccountBaseDAL dal=new Sys_AccountBaseDAL();
        ...
        public static List<Sys_Account> GetList(List<DapperWhere> dapperWheres)
        {
        	Sys_AccountBaseDAL dal=new Sys_AccountBaseDAL();
        ...
        public static List<Sys_Account> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	Sys_AccountBaseDAL dal=new Sys_AccountBaseDAL();
        ...
        public static List<Sys_Account> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	Sys_AccountBaseDAL dal=new Sys_AccountBaseDAL();
