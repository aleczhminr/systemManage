...
{
	 	//Sys_VisitEmail
		public static class Sys_VisitEmailBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(Sys_VisitEmail model)
		{   
		 Sys_VisitEmailBaseDAL dal=new Sys_VisitEmailBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(Sys_VisitEmail model)
        {
		 Sys_VisitEmailBaseDAL dal=new Sys_VisitEmailBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sys_VisitEmail GetModel(int id){
        Sys_VisitEmailBaseDAL dal=new Sys_VisitEmailBaseDAL();
        ...
        public static List<Sys_VisitEmail> GetList(List<DapperWhere> dapperWheres)
        {
        	Sys_VisitEmailBaseDAL dal=new Sys_VisitEmailBaseDAL();
        ...
        public static List<Sys_VisitEmail> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	Sys_VisitEmailBaseDAL dal=new Sys_VisitEmailBaseDAL();
        ...
        public static List<Sys_VisitEmail> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	Sys_VisitEmailBaseDAL dal=new Sys_VisitEmailBaseDAL();
