...
{
	 	//Sys_TaskType
		public static class Sys_TaskTypeBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(Sys_TaskType model)
		{   
		 Sys_TaskTypeBaseDAL dal=new Sys_TaskTypeBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(Sys_TaskType model)
        {
		 Sys_TaskTypeBaseDAL dal=new Sys_TaskTypeBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sys_TaskType GetModel(int id){
        Sys_TaskTypeBaseDAL dal=new Sys_TaskTypeBaseDAL();
        ...
        public static List<Sys_TaskType> GetList(List<DapperWhere> dapperWheres)
        {
        	Sys_TaskTypeBaseDAL dal=new Sys_TaskTypeBaseDAL();
        ...
        public static List<Sys_TaskType> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	Sys_TaskTypeBaseDAL dal=new Sys_TaskTypeBaseDAL();
        ...
        public static List<Sys_TaskType> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	Sys_TaskTypeBaseDAL dal=new Sys_TaskTypeBaseDAL();
