...
{
	 	//Sys_Visit
		public static class Sys_VisitBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(Sys_Visit model)
		{   
		 Sys_VisitBaseDAL dal=new Sys_VisitBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(Sys_Visit model)
        {
		 Sys_VisitBaseDAL dal=new Sys_VisitBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sys_Visit GetModel(int id){
        Sys_VisitBaseDAL dal=new Sys_VisitBaseDAL();
        ...
        public static List<Sys_Visit> GetList(List<DapperWhere> dapperWheres)
        {
        	Sys_VisitBaseDAL dal=new Sys_VisitBaseDAL();
        ...
        public static List<Sys_Visit> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	Sys_VisitBaseDAL dal=new Sys_VisitBaseDAL();
        ...
        public static List<Sys_Visit> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	Sys_VisitBaseDAL dal=new Sys_VisitBaseDAL();
