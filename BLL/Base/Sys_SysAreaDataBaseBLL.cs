...
{
	 	//Sys_SysAreaData
		public static class Sys_SysAreaDataBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(Sys_SysAreaData model)
		{   
		 Sys_SysAreaDataBaseDAL dal=new Sys_SysAreaDataBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(Sys_SysAreaData model)
        {
		 Sys_SysAreaDataBaseDAL dal=new Sys_SysAreaDataBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sys_SysAreaData GetModel(int id){
        Sys_SysAreaDataBaseDAL dal=new Sys_SysAreaDataBaseDAL();
        ...
        public static List<Sys_SysAreaData> GetList(List<DapperWhere> dapperWheres)
        {
        	Sys_SysAreaDataBaseDAL dal=new Sys_SysAreaDataBaseDAL();
        ...
        public static List<Sys_SysAreaData> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	Sys_SysAreaDataBaseDAL dal=new Sys_SysAreaDataBaseDAL();
        ...
        public static List<Sys_SysAreaData> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	Sys_SysAreaDataBaseDAL dal=new Sys_SysAreaDataBaseDAL();
