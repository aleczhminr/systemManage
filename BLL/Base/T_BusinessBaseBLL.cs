...
{
	 	//T_Business
		public static class  T_BusinessBaseBLL
	{
        ...
        T_BusinessBaseDAL dal=new T_BusinessBaseDAL();
        ...
        public static List< T_Business> GetList(List<DapperWhere> dapperWheres)
        {
        	T_BusinessBaseDAL dal=new T_BusinessBaseDAL();
        ...
        public static List<T_Business> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	T_BusinessBaseDAL dal=new T_BusinessBaseDAL();
        ...
        public static List<T_Business> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	T_BusinessBaseDAL dal=new T_BusinessBaseDAL();
