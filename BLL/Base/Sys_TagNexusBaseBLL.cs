...
{
	 	//Sys_TagNexus
		public static class Sys_TagNexusBaseBLL
	{
		...
		{   
		 Sys_TagNexusBaseDAL dal=new Sys_TagNexusBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(Sys_TagNexus model)
        {
		 Sys_TagNexusBaseDAL dal=new Sys_TagNexusBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sys_TagNexus GetModel(int id){
        Sys_TagNexusBaseDAL dal=new Sys_TagNexusBaseDAL();
        ...
        public static List<Sys_TagNexus> GetList(List<DapperWhere> dapperWheres)
        {
        	Sys_TagNexusBaseDAL dal=new Sys_TagNexusBaseDAL();
        ...
        public static List<Sys_TagNexus> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	Sys_TagNexusBaseDAL dal=new Sys_TagNexusBaseDAL();
        ...
        public static List<Sys_TagNexus> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	Sys_TagNexusBaseDAL dal=new Sys_TagNexusBaseDAL();
