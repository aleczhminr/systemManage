...
{
	 	//T_Sms_List
		public static class  T_Sms_ListBaseBLL
	{
        ...
        /// 得到一个对象实体
        /// </summary>
        public static T_Sms_List GetModel(int id){
        T_Sms_ListBaseDAL dal=new T_Sms_ListBaseDAL();
        ...
        public static List< T_Sms_List> GetList(List<DapperWhere> dapperWheres)
        {
        	T_Sms_ListBaseDAL dal=new T_Sms_ListBaseDAL();
        ...
        public static List< T_Sms_List> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	T_Sms_ListBaseDAL dal=new T_Sms_ListBaseDAL();
        ...
        public static List< T_Sms_List> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	T_Sms_ListBaseDAL dal=new T_Sms_ListBaseDAL();
