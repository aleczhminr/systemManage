...
{
	 	//HtmlCouponCount
		public static class HtmlCouponCountBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(HtmlCouponCount model)
		{   
		 HtmlCouponCountBaseDAL dal=new HtmlCouponCountBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(HtmlCouponCount model)
        {
		 HtmlCouponCountBaseDAL dal=new HtmlCouponCountBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static HtmlCouponCount GetModel(int id){
        HtmlCouponCountBaseDAL dal=new HtmlCouponCountBaseDAL();
        ...
        public static List<HtmlCouponCount> GetList(List<DapperWhere> dapperWheres)
        {
        	HtmlCouponCountBaseDAL dal=new HtmlCouponCountBaseDAL();
        ...
        public static List<HtmlCouponCount> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	HtmlCouponCountBaseDAL dal=new HtmlCouponCountBaseDAL();
        ...
        public static List<HtmlCouponCount> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	HtmlCouponCountBaseDAL dal=new HtmlCouponCountBaseDAL();
