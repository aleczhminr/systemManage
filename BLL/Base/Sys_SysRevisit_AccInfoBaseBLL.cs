...
namespace BLL.Base
{
		...
		public static class Sys_SysRevisit_AccInfoBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(Sys_SysRevisit_AccInfo model)
		{   
		 Sys_SysRevisit_AccInfoBaseDAL dal=new Sys_SysRevisit_AccInfoBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(Sys_SysRevisit_AccInfo model)
        {
		 Sys_SysRevisit_AccInfoBaseDAL dal=new Sys_SysRevisit_AccInfoBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sys_SysRevisit_AccInfo GetModel(int id){
        Sys_SysRevisit_AccInfoBaseDAL dal=new Sys_SysRevisit_AccInfoBaseDAL();
        ...
        public static List<Sys_SysRevisit_AccInfo> GetList(List<DapperWhere> dapperWheres)
        {
        	Sys_SysRevisit_AccInfoBaseDAL dal=new Sys_SysRevisit_AccInfoBaseDAL();
        ...
        public static List<Sys_SysRevisit_AccInfo> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	Sys_SysRevisit_AccInfoBaseDAL dal=new Sys_SysRevisit_AccInfoBaseDAL();
        ...
        public static List<Sys_SysRevisit_AccInfo> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	Sys_SysRevisit_AccInfoBaseDAL dal=new Sys_SysRevisit_AccInfoBaseDAL();
