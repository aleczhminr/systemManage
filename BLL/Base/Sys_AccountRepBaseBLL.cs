...
{
	 	//Sys_AccountRep
		public static class Sys_AccountRepBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(Sys_AccountRep model)
		{   
		 Sys_AccountRepBaseDAL dal=new Sys_AccountRepBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(Sys_AccountRep model)
        {
		 Sys_AccountRepBaseDAL dal=new Sys_AccountRepBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sys_AccountRep GetModel(int id){
        Sys_AccountRepBaseDAL dal=new Sys_AccountRepBaseDAL();
        ...
        public static List<Sys_AccountRep> GetList(List<DapperWhere> dapperWheres)
        {
        	Sys_AccountRepBaseDAL dal=new Sys_AccountRepBaseDAL();
        ...
        public static List<Sys_AccountRep> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	Sys_AccountRepBaseDAL dal=new Sys_AccountRepBaseDAL();
        ...
        public static List<Sys_AccountRep> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	Sys_AccountRepBaseDAL dal=new Sys_AccountRepBaseDAL();
