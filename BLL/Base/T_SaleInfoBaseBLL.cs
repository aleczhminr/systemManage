...
{
	 	//T_SaleInfo
		public static class T_SaleInfoBaseBLL
	{
        ...
        /// 得到一个对象实体
        /// </summary>
        public static T_SaleInfo GetModel(int saleID){
        T_SaleInfoBaseDAL dal=new T_SaleInfoBaseDAL();
        ...
        public static List<T_SaleInfo> GetList(List<DapperWhere> dapperWheres)
        {
        	T_SaleInfoBaseDAL dal=new T_SaleInfoBaseDAL();
        ...
        public static List<T_SaleInfo> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	T_SaleInfoBaseDAL dal=new T_SaleInfoBaseDAL();
        ...
        public static List<T_SaleInfo> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	T_SaleInfoBaseDAL dal=new T_SaleInfoBaseDAL();
