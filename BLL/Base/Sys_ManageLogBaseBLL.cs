...
{
	 	//Sys_ManageLog
		public static class Sys_ManageLogBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(Sys_ManageLog model)
		{   
		 Sys_ManageLogBaseDAL dal=new Sys_ManageLogBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(Sys_ManageLog model)
        {
		 Sys_ManageLogBaseDAL dal=new Sys_ManageLogBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sys_ManageLog GetModel(int ID){
        Sys_ManageLogBaseDAL dal=new Sys_ManageLogBaseDAL();
        ...
        public static List<Sys_ManageLog> GetList(List<DapperWhere> dapperWheres)
        {
        	Sys_ManageLogBaseDAL dal=new Sys_ManageLogBaseDAL();
        ...
        public static List<Sys_ManageLog> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	Sys_ManageLogBaseDAL dal=new Sys_ManageLogBaseDAL();
        ...
        public static List<Sys_ManageLog> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	Sys_ManageLogBaseDAL dal=new Sys_ManageLogBaseDAL();
