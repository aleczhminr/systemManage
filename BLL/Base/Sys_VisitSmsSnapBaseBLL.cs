...
{
	 	//Sys_VisitSmsSnap
		public static class Sys_VisitSmsSnapBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(Sys_VisitSmsSnap model)
		{   
		 Sys_VisitSmsSnapBaseDAL dal=new Sys_VisitSmsSnapBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(Sys_VisitSmsSnap model)
        {
		 Sys_VisitSmsSnapBaseDAL dal=new Sys_VisitSmsSnapBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sys_VisitSmsSnap GetModel(int id){
        Sys_VisitSmsSnapBaseDAL dal=new Sys_VisitSmsSnapBaseDAL();
        ...
        public static List<Sys_VisitSmsSnap> GetList(List<DapperWhere> dapperWheres)
        {
        	Sys_VisitSmsSnapBaseDAL dal=new Sys_VisitSmsSnapBaseDAL();
        ...
        public static List<Sys_VisitSmsSnap> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	Sys_VisitSmsSnapBaseDAL dal=new Sys_VisitSmsSnapBaseDAL();
        ...
        public static List<Sys_VisitSmsSnap> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	Sys_VisitSmsSnapBaseDAL dal=new Sys_VisitSmsSnapBaseDAL();
