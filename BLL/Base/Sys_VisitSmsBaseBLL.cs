...
{
	 	//Sys_VisitSms
		public static class Sys_VisitSmsBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(Sys_VisitSms model)
		{   
		 Sys_VisitSmsBaseDAL dal=new Sys_VisitSmsBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(Sys_VisitSms model)
        {
		 Sys_VisitSmsBaseDAL dal=new Sys_VisitSmsBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sys_VisitSms GetModel(int id){
        Sys_VisitSmsBaseDAL dal=new Sys_VisitSmsBaseDAL();
        ...
        public static List<Sys_VisitSms> GetList(List<DapperWhere> dapperWheres)
        {
        	Sys_VisitSmsBaseDAL dal=new Sys_VisitSmsBaseDAL();
        ...
        public static List<Sys_VisitSms> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	Sys_VisitSmsBaseDAL dal=new Sys_VisitSmsBaseDAL();
        ...
        public static List<Sys_VisitSms> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	Sys_VisitSmsBaseDAL dal=new Sys_VisitSmsBaseDAL();
