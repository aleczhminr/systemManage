...
{
	 	//Sys_DayCheckLog
		public static class Sys_DayCheckLogBaseBLL
	{
        ...
        /// <returns></returns>
        public static int Add(Sys_DayCheckLog model)
		{   
		 Sys_DayCheckLogBaseDAL dal=new Sys_DayCheckLogBaseDAL();
        ...
        /// 更新一条数据
        /// </summary>
        public static bool Update(Sys_DayCheckLog model)
        {
		 Sys_DayCheckLogBaseDAL dal=new Sys_DayCheckLogBaseDAL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public static Sys_DayCheckLog GetModel(int id){
        Sys_DayCheckLogBaseDAL dal=new Sys_DayCheckLogBaseDAL();
        ...
        public static List<Sys_DayCheckLog> GetList(List<DapperWhere> dapperWheres)
        {
        	Sys_DayCheckLogBaseDAL dal=new Sys_DayCheckLogBaseDAL();
        ...
        public static List<Sys_DayCheckLog> GetList(int top, List<DapperWhere> dapperWheres, string filedOrder){
        	Sys_DayCheckLogBaseDAL dal=new Sys_DayCheckLogBaseDAL();
        ...
        public static List<Sys_DayCheckLog> GetList(int pageIndex,int pageSize,List<DapperWhere> dapperWheres,string filedOrder)
        {
        	Sys_DayCheckLogBaseDAL dal=new Sys_DayCheckLogBaseDAL();
